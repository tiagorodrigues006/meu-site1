                ...
                <div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										...
										<form method="POST" action="">
										 <a href="index.php?pagina=registar_acessorios2"><label class="btn btn-primary">Adicionar <i class="fa fa-plus"></i></label></a>
										 &nbsp;
                        ...
                        <table class="table mb-none" id="datatable-details">
                                        ...
                                        <?php
                                            ...
                                            <tr class="gradeX">
                                                <td> <?php echo $id_acessorio; ?> </td>
                                                <td> <?php echo $acessorios; ?> </td>
                                            </tr>
