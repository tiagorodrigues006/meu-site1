            ...
            <header class="page-header">
                ...
                <div class="right-wrapper pull-right">
                    <ol class="breadcrumbs" style=" margin-right: 30px;">
                        ...
                        <li><span>Tipos de Equipamentos</span></li>
                    </ol>
                </div>
            </header>
                ...
                <div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										...
										<form method="POST" action="">
										 <a href="index.php?pagina=registar_tipoequipamentos"><label class="btn btn-primary">Adicionar <i class="fa fa-plus"></i></label></a>
										 &nbsp;
                        ...
                        <table class="table mb-none" id="datatable-details">
                                        ...
                                        <?php
                                            ...
                                            $altera="Select * from tipo_equipamento";
