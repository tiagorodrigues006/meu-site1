...
if(isset($_POST["inserir_reparacao"])){
    ...
    $query = "INSERT INTO logsreparacao(idreparacao,idequipamento,estado,tecnico) VALUES('".$idr."', '".$ide ."','".$stade ."', '".$tecnic ."')";

    if ($ligax->query($query) === true)
    {
    }
    else{
    } 
...
$passbios=$_POST["passbios"];
                    ...
                    outraavaria='".$outraavaria."', descricao='".$descricao."', pass='".$pass."', passbios='".$passbios."' 
...
//APRESENTAR DADOS
    ...
    $anexo2_nome=$registo['anexo2_nome'];
    $anexo3_nome=$registo['anexo3_nome'];
                ...
                <div class="panel panel-sign" >
                    ...
                    <form method="POST" action="#" enctype="multipart/form-data">
                        ...
                        <div style="width: 60%; float: left; overflow: hidden;">
                            ...
                            <div class="form-group mb-lg" style="width: 14%; overflow: hidden; float: left;margin-right:15px; margin-left: 50px;">
...
Mail: <?php echo $email; ?>" style="margin-top: 0; float: right; color: #0088cc">Contacto</label>
                            ...
                            <div style="width: 15%; float: left; overflow: hidden; padding-top:4%; margin-left:25px;">
                                ...
                                <div style="overflow: hidden;padding-left:3%;">
                                    <button value="SAVE" style="float:right;" name="registar_reparacao" class="btn btn-primary hidden-xs"> <i class="glyphicon glyphicon-floppy-disk"></i> SAVE</button>
                                </div>
                    ...
                    <div class="form-group mb-lg">          
                        ...
                        <div class="form-group mb-lg" style="width: 15%; overflow: hidden; float: left;margin-right:10px;  margin-left:100px;">
                                ...
                                <input name="idequipamento" type="text" class="form-control input-lg" value="<?php echo $idreparacao; ?>" disabled=""/>
                            </div>
                        ...
                        <div class="form-group mb-lg" style="width: 15%; overflow: hidden;float:left; margin-left:0px; margin-right:10px;">
                                ...
                                <input name="idequipamento" type="text" class="form-control input-lg"  style="font-weight: bold;" value="<?php echo $idequipamento; ?>" disabled=""/>
                                <input type="hidden" id="idequipamento" value="<?php echo $idequipamento; ?>">
                            ...
                            <div class="form-group mb-lg" style="width: 15%; float: left; overflow: hidden; padding-top:4%; margin-left:25px;">
                                <a href="index.php?pagina=listar_reparacoes&idc=<?php echo $idcliente; ?>&ide=<?php echo $idequipamento; ?>" target="_blank"><label class="form-control  btn btn-primary hidden-xs" style="">Histórico</label> </a>
                            </div>
                        ...
                        <div style="float: right; width: 25%; margin: 0 auto; margin-top: -10px;">
                            ...
                            <label style="margin-top: 0;">Marca</label>
												...
												$num=mysqli_num_rows($resultmarca);
												if($num>=1) { $marcaatual=$registo['marca']; }
												?>
												
												 <input name="tipo" type="text" class="form-control input-lg"  value="<?php if($num>=1){ echo $marcaatual; } ?>" disabled="" />
   ...
   <div class="form-group mb-lg" style="width: 100%; float: left; overflow: hidden;">
                    ...
                    <h4 style="width: 100%; float: left; margin-top: 0; margin-bottom: 25px;">Avaria</h4>
                        ...
                        <div class="form-group mb-lg" style="width: 100%; float: left; overflow: hidden; margin-top: -20px;">
                        <label style="margin-top: 0;"></label>
                        <input name="descricao" type="textarea" class="form-control input-lg" value="<?php echo $descricao; ?>"   placeholder="Observações" style="rows='5' ; cols='100'"/>
                        </div>
			...
			<div id="edit" class="tab-pane">
                        ...
                        <div style="overflow: hidden;padding-left:3%; ">
                                    <button value="SAVE" style="float:right;" name="registar_intervencao" class="btn btn-primary hidden-xs"> <i class="glyphicon glyphicon-floppy-disk"></i> SAVE</button>
                        </div>
                        ...
                        <div class="form-group mb-lg" style="width: 45%; float: right;">
                        ...
                        <?php }
                         ...
                         <div class="form-group mb-lg" style="width: 10%; float: right; overflow: hidden;">
                				...
                				<label>Anexos</label>
                		    		...
                		    		<?php } ?>
                						<input type="file" name="foto" onchange="displayimage(this)" id="foto" style="display: none; width:10px" />
                				</div><br>

                                <div class="input-group">
                					<?php if($anexo2_nome==NULL){ ?>
                		    			<img src='../img/image2.png' onclick="triggerclick()" id="profiledisplay" >
                		    		<?php } else { ?>
                		    			<img src="showfile_anexo2.php?id_reparacao=<?php echo $idreparacao;?>" onclick="triggerclick()" id="profiledisplay" />
                                ...
                                <div class="input-group">
                					<?php if($anexo3_nome==NULL){ ?>
                		    			<img src='../img/image2.png' onclick="triggerclick()" id="profiledisplay" >
                		    		<?php } else { ?>
                		    			<img src="showfile_anexo3.php?id_reparacao=<?php echo $idreparacao;?>" onclick="triggerclick()" id="profiledisplay" />
                          ...
                          <div class="form-group mb-lg" style="width: 60%; overflow: hidden; float: left;">
                            ...
                            <textarea name="outraint" type="text" class="form-control input-lg" rows="4" cols="70"><?php echo $outraint; ?></textarea>
                        </div>
                        ...
                        <div class="form-group mb-lg" style="width: 60%; float: left; overflow: hidden;">
                            ...
                            <textarea name="observacao" type="text" class="form-control input-lg" rows="2" cols="100"><?php echo $observacao; ?></textarea>
                        </div>
                        
                        
                        <div class="form-group mb-lg" style="width: 30%; overflow: hidden; padding:10px;">
