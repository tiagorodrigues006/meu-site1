					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 30px">
							<ol class="breadcrumbs">
								...
								<li><span>Reparações Fechado</span></li>
							</ol>
    ...
    <section class="body-sign">
							...
							<br>
								<table class="table table-bordered table-striped mb-none" id="datatable-details" style="width:100%;">
									<thead>
										<tr>
											<th style="width : 3%;">ID_Rep</th>
											<th style="padding-right:50px;">Nome</th>
											<th style="width : 3%;">ID_Equip</th>
                                 ...
                                 $altera="Select * from reparacao where (id_reparacao = '".$idr."' or id_cliente like '".$idc."' or id_equipamento like '".$ide."' or valor like '".$val."' or pago like '".$pag."'
								  or data like '".$datar."'  or dataentrega like '".$dataentregar."') and estado = '".$est."' ORDER BY data DESC" ;
                                        ...
                                        $altera= "select * from reparacao where estado IN ('9') ORDER BY data DESC";
                                        $result= mysqli_query($ligax, $altera);
                                 	}
                                        if ($result) {
