...
$insere="INSERT INTO reparacao (id_cliente,id_equipamento,estado,outroacess,outraavaria,descricao,dataentrega,dataconclusao,pass,passbios)
                    VALUES ('".$idcliente."', '".$idequipamento ."','".$estado ."', '".$outroacess ."', '".$outraavaria ."', '".$descricao ."','".$dataentrega ."','".$dataconclusao ."','".$pass ."','".$passbios ."')";
               echo $insere;    
...
/* Guardar os dados do vetor $_POST para a respetiva variável */
        ...
        $atualizar="UPDATE reparacao set estado='".$estado."',  label1='".$interv[1]."', label2='".$interv[2]."', label3='".$interv[3]."', 
            label4='".$interv[4]."', label5='".$interv[5]."', label6='".$interv[6]."', label7='".$interv[7]."', label8='".$interv[8]."', label9='".$interv[9]."', label10='".$interv[10]."', dataconclusao='".$dataconclusao."', outraint='".$outraint."', 
        valor='".$valor."', aviso='".$aviso."', pago='".$pago."', outrachckl='".$outrachckl."', observacao='".$observacao."', pass='".$pass."', passbios='".$passbios."' where id_reparacao='".$_POST['idreparacao']."'";
			        $result=mysqli_query($ligax,$atualizar);
			        echo $atualizar;
 ...
 <section class="body-sign">
                ...
                <div class="panel panel-sign" >
                    ...
                    <div class="panel-body">
								...
								<div style="float: right; padding-left: 1%">
										<a href="print.php?idc=<?php echo $idcliente; ?>&idr=<?php echo $idreparacao; ?>&ide=<?php echo $idequipamento; ?>" target="_blank"><button value="SV" class="btn btn-primary hidden-xs"> <i class="fa fa-print"></i> Ent</button></a>
								</div>
									<div style="float: right; padding-left: 1%">
										<a href="print.php?idc=<?php echo $idcliente; ?>&idr=<?php echo $idreparacao; ?>&ide=<?php echo $idequipamento; ?>" target="_blank"><button value="ENT" class="btn btn-primary hidden-xs"> <i class="fa fa-print"></i> Selo</button></a>
								</div>
									<div style="float: right; padding-left: 1%">
										<a href="print.php?idc=<?php echo $idcliente; ?>&idr=<?php echo $idreparacao; ?>&ide=<?php echo $idequipamento; ?>" target="_blank"><button value="SAI" class="btn btn-primary hidden-xs"> <i class="fa fa-print"></i> SAI</button></a>
								</div>
									<div style="float: right; padding-left: 1%">
										<a href="print.php?idc=<?php echo $idcliente; ?>&idr=<?php echo $idreparacao; ?>&ide=<?php echo $idequipamento; ?>" target="_blank"><button value="FI" class="btn btn-primary hidden-xs"> <i class="fa fa-print"></i> FI</button></a>
								</div>
								</ul>
                        ...
                        <div class="form-group mb-lg" style="width: 45%; float: right; overflow: hidden;">
                            <p style="margin-top: 0;">Data de Entrada</p>
                              <input name="data" type="datetime" class="form-control input-lg" value="<?php echo $data; ?>"/>
                    ...
                    <h4 style="width: 100%; float: left; margin-top: 0; margin-top: -10px;">Cliente</h4>
                            ...
                            <div style="width: 13%; float: left; overflow: hidden;">
                                ...
                                <div style="width: 35%; float: left; overflow: hidden; padding-left:3%; ">
                                    ...
                                    <input name="telefone1" type="text" class="form-control input-lg" value="<?php echo $telefone1; ?>" disabled=""/>
                                </div>
                                <div style="width: 15%; float: left; overflow: hidden; padding-left:3%; padding-top:3%; ">
                                    <a href="index.php?pagina=Editar_Cliente&id=<?php echo $idcliente; ?>"><label class="form-control input-lg">Perfil</label> </a>
                                </div>
                            </div>
                    
                        <div style="float: left; width: 45%; margin: 0 auto; margin-top: -10px;">
                            
                            <h4 style="margin-top: 0;">Equipamento</h4>
                            
                            <div class="form-group mb-lg" style="width: 60%; overflow: hidden;">
                        ...
                        <div style="float: right; width: 45%; margin: 0 auto; margin-top: -10px;">
                            
                            <h4 style="margin-top: 0;">Reparação</h4>
   ...
   <div class="form-group mb-lg" style="width: 100%; float: left; overflow: hidden;">
                    ...
                    <h4 style="width: 100%; float: left; margin-top: 0; margin-bottom: 25px;">Avaria</h4>
                        ...
                        <div class="form-group mb-lg" style="width: 100%; float: left; overflow: hidden; margin-top: -20px;">
                        <label style="margin-top: 0;">Outro</label>
                        <input name="outraavaria" type="textarea" class="form-control input-lg" value="<?php echo $outraavaria; ?>" />
                        </div>
                        ...
                        <input name="descricao" type="textarea" class="form-control input-lg" value="<?php echo $descricao; ?>" />
                            ...
                            <div class="row">
                                <div class="col-sm-12 mb-lg">
                                   <a href="index.php?pagina=verhistorico&ide=<?php echo $idequipamento; ?> "> <label class="btn btn-primary">Voltar </label></a> 
			...
			<div id="edit" class="tab-pane">
                        ...
                        <?php }
                          ...
                          <div class="form-group mb-lg" style="width: 60%; overflow: hidden; float: left;">
                            ...
                            <div class="form-group mb-lg" style="width: 30%; float: right; overflow: hidden;">
                            <label style="margin-top: 0;">Outro</label>
                            <textarea name="outrachckl" type="text" class="form-control input-lg" /><?php echo $outrachckl; ?> </textarea>
                        </div>
                        ...
                        <br>
                            ...
                            <input name="dataconclusao" type="date" class="form-control input-lg" value="<?php echo $dataconclusao; ?>" style="font-size: 16px;" />
                        ...
                        <br>
                            ...
                            <input name="dataentrega" type="text" class="form-control input-lg" value="<?php echo $dataentrega; ?>" />
