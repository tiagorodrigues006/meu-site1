                ...
                <div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										...
										<form method="POST" action="">
										 <a href="index.php?pagina=registar_intervencao"><label class="btn btn-primary">Adicionar <i class="fa fa-plus"></i></label></a>
										 &nbsp;
                        ...
                        <table class="table mb-none" id="datatable-details">
                                        ...
                                        <?php
                                            ...
                                            $altera="SELECT * FROM `intervencao` ORDER BY `intervencao`.`id_intervencao` ASC
                                            ";
                                            ...
                                            $id_intervencao=$registo['id_intervencao'];
                                            $intervencao=$registo['intervencao'];

                                            ?>

                                            <tr class="gradeX">
                                                <td> <?php echo $id_intervencao; ?> </td>
                                                <td> <?php echo $intervencao; ?> </td>
                                            </tr>
