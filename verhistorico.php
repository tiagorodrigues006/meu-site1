					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 30px">
							<ol class="breadcrumbs">
								...
								<li><span>Listar Reparações</span></li>
							</ol>
						</div>
					</header>
    ...
    <section class="body-sign">
							...
							<?php //echo $idequip;?>
								<table class="table table-bordered table-striped mb-none" id="datatable-details" style="width:100%;">
									<thead>
										<tr>
											<th style="width : 5%;">ID_Reparação</th>
											<th style="width : 5%;">ID_Cliente</th>
											<th style="width : 20%;">Nome</th>
											<th style="width : 10%;">ID_Equipamento</th>
											<th>Estado</th>
                                            <th style="width : 40%; padding-right: 100px;">Data</th>
                                            <th style="width : 10%;">DataEntrega</th>
                                            <th>Perfil</th>
										</tr>
									</thead>
									<tbody>
                                 ...
                                 <?php
                                 			...
                                 			$equipc="SELECT * from reparacao where id_equipamento like '".$idequip."' ORDER BY id_reparacao DESC";
...
Mail: <?php echo $mail; ?>">
                                    ...
                                    ?>
											...
											<td><a href="index.php?pagina=verhistoricoperfil&idr=<?php echo $id_reparacao; ?>" ><i class="fa fa-pencil"></i></a></td>
										</tr>
