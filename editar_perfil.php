				...
				<div class="row">
						...
						<div class="col-md-8 col-lg-6">
							...
							<div class="tabs">
								...
								<li class="active">
								<a href="index.php?pagina=editar_perfil" data-toggle="tab">Perfil</a>
									</li>
									<li>
										<a href="index.php?pagina=password" data-toggle="tab">password</a>
									</li>
								</ul>
								...
								<form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
											...
											<fieldset>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<input type="password" class="form-control" id="profilePassword" name="pass" value="">
													</div>
												</div>
											</fieldset>
